...
import static TeamDevelopmentTGbot.settings.MessagesConst.*;
import static TeamDevelopmentTGbot.settings.AlphabetGroup.*;
import static TeamDevelopmentTGbot.settings.HermitageArtists.*;
@Component
public class HermitageInlineKeyboardAb {

    public HermitageInlineKeyboardAb(){}

    public static SendMessage hermitageInlineKeyboardAb(long chat_id) {

        SendMessage message = new SendMessage(chat_id,ART);
...
//        message.replyMarkup(rowsInline);
        return message;
